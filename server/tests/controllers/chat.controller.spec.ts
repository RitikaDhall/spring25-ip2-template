...
describe('Chat Controller', () => {
  describe('POST /chat/createChat', () => {
    ...
    it('should return 500 if error occurrs while creating a chat', async () => {
  ...
  describe('POST /chat/:chatId/addMessage', () => {
    ...
    it('should return 500 error if message creation fails', async () => {
      ...
      const messagePayload: Message = {
        msg: 'Test',
        msgFrom: 'testUser1',
        msgDateTime: new Date('2025-06-01'),
        type: 'direct',
      };
  ...
  describe('GET /chat/:chatId', () => {
    ...
    it('should return 500 if an error occurs while retrieving chats', async () => {
      const chatId = new mongoose.Types.ObjectId().toString();
  ...
  describe('POST /chat/:chatId/addParticipant', () => {
    ...
    it('should return 400 in case of invalid request body', async () => {
      const chatId = new mongoose.Types.ObjectId().toString();
